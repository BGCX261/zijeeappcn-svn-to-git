 ...
 * values of the resulting byte sequences. ** @author Ron Hitchens
 * (ron@ronsoft.com)
 * */
public class EncodeTest {
    ...
    /**
     * * For a given Charset and input string, encode the chars * and print out
     * the resulting byte encoding in a readable form.
     * */
