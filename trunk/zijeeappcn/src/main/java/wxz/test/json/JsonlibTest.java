...
//		jsonObject = new JSONObject().element("string", "JSON").element(
//				"integer", "1").element("double", "2.0").element("boolean",
//				"true");
...
//	}
//
//	private String json2 = "{\"address\":\"chian\",\"birthday\":{\"birthday\":\"2010-11-22\"},"
//			+ "\"email\":\"email@123.com\",\"id\":22,\"name\":\"tom\"}";
//
...
//			fail(JSONArray.fromObject(json2).join(""));
//			fail(os[0].toString());
...
//	}
	...
	String json2 ="{\"address\":\"address\",\"birthday\":{\"birthday\":\"2010-11-22\"},\"date\":{\"date\":22,\"day\":4,\"hours\":14,\"minutes\":47,\"month\":7,\"seconds\":35,\"time\":1377154055984,\"timezoneOffset\":-480,\"year\":113},\"email\":\"email\",\"id\":1,\"name\":\"jack\"},{\"address\":\"address\",\"birthday\":{\"birthday\":\"2010-11-22\"},\"date\":{\"date\":22,\"day\":4,\"hours\":14,\"minutes\":47,\"month\":7,\"seconds\":35,\"time\":1377154055984,\"timezoneOffset\":-480,\"year\":113},\"email\":\"email\",\"id\":1,\"name\":\"jack\"}";
...
//
//	private String json3 = "{\"address\":\"chian\",\"birthday\":{\"birthday\":\"2010-11-22\"},"
//			+ "\"email\":\"email@123.com\",\"id\":22,\"name\":\"tom\"}";
//
//	@Test
...
//			json3 = "[" + json3 + "]";
//			jsonArray = JSONArray.fromObject(json3);
